...
SET(CMAKE_INSTALL_PREFIX "W:/Cloud/Projects/nervcry/software" CACHE STRING "Installation folder" FORCE)
SET(TOOLS_DIR "${PROJECT_SOURCE_DIR}/tools" CACHE STRING "Folder containing all the needed dev tools")

SET(USE_COMPRESSION TRUE)

SET(FLAVOR "win32" CACHE STRING "target compilation flavor.")
...
# Dependencies paths:
SET(DEP_BOOST ${DEPS_DIR}/${DEP_FLAVOR}/boost-1.53.0 CACHE STRING "boost path")
SET(DEP_LUA ${DEPS_DIR}/${DEP_FLAVOR}/LuaJIT-2.0.1 CACHE STRING "lua path")
SET(DEP_OSG ${DEPS_DIR}/${DEP_FLAVOR}/OpenSceneGraph-3.1.5 CACHE STRING "osg path")
SET(DEP_WX ${DEPS_DIR}/${DEP_FLAVOR}/wxWidgets-2.9.3 CACHE STRING "wx path")
SET(DEP_GLEW ${DEPS_DIR}/${DEP_FLAVOR}/glew-1.9.0 CACHE STRING "GLEW path")
# SET(DEP_GLUT ${DEPS_DIR}/${DEP_FLAVOR}/glut-3.7.6 CACHE STRING "GLUT path")
SET(DEP_GLUT ${DEPS_DIR}/${DEP_FLAVOR}/freeglut-2.8.1 CACHE STRING "GLUT path")
# SET(DEP_GLUT ${DEPS_DIR}/${DEP_FLAVOR}/freeglut-2.6.0 CACHE STRING "GLUT path")
SET(DEP_ICONV ${DEPS_DIR}/${DEP_FLAVOR}/libiconv-1.9.2-1 CACHE STRING "iconv path")
SET(DEP_PTHREADS ${DEPS_DIR}/${DEP_FLAVOR}/pthreads-w32-2.9.1 CACHE STRING "pthreads path")
SET(DEP_ATB ${DEPS_DIR}/${DEP_FLAVOR}/AntTweakBar-1.15 CACHE STRING "AntTweakBar path")
SET(DEP_TIFF ${DEPS_DIR}/${DEP_FLAVOR}/libtiff-3.8.2 CACHE STRING "TIFF path")
SET(DEP_AWESOMIUM ${DEPS_DIR}/${DEP_FLAVOR}/awesomium-1.7-rc3 CACHE STRING "awesomium path")
...
SET(CRY_DIR X:/Softwares/CryEngine-3.5.8 CACHE STRING "Cry engine path")
