...
public:
	...
	SC_API static bool s_usedDataIds[MAX_CONCURRENT_HUDEVENTS];
	SC_API static THUDEventDataStack s_dataStack;
...
namespace CHUDEventDispatcher
{
	...
	SC_API void		AddHUDEventListener(IHUDEventListener* listener, const char* eventName);
	SC_API void		AddHUDEventListener(IHUDEventListener* listener, EHUDEventType eventType);
	SC_API void		RemoveHUDEventListener(const IHUDEventListener* listener);
	SC_API void		CallEvent(const SHUDEvent& event);
