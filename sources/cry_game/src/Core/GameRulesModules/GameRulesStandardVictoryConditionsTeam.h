...
enum ESV_Flags
{
	...
	eSVCF_CanPlayMusicMoods												= BIT(15),
};
...
public:
  ...
  virtual void  SetWinningKillVictimShooter(EntityId victim, EntityId shooter) { m_winningVictim = victim; m_winningAttacker = shooter; }
	...
	virtual void SetCanPlayMusicMoods(bool bEnable);
...
protected:
	...
	void GetGameOverAnnouncementAndMusic(const EGameOverType gameOverType, const int clientScore, const int opponentScore, TAudioSignalID &musicSignal, EAnnouncementID& announcement);
