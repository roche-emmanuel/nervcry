	...
	case (eVAI_RotateYaw):
		{
			...
			{
				value = clamp(g_pGameCVars->v_mouseRotScaleMP*value, -g_pGameCVars->v_mouseRotLimitMP, g_pGameCVars->v_mouseRotLimitMP) * sensitivity;
			}
			else
			{
				value = clamp(g_pGameCVars->v_mouseRotScaleSP*value, -g_pGameCVars->v_mouseRotLimitSP, g_pGameCVars->v_mouseRotLimitSP) * sensitivity;
			}
