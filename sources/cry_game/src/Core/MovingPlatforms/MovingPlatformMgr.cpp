// The motivation for this class is to detect objects that are on moving platforms
// and avoid net-serialising them if they are at "rest" on the platform
// They are forced to the same location by driving their velocity each frame
