...
, m_pICharacterModelSkeleton( NULL )
, m_pVerticalAim( NULL )
...
void CProceduralContextTurretAimPose::SetHorizontalAimJointName( const char* horizontalAimJointName )
{
	...
	const int16 horizontalAimJointId = m_pICharacterModelSkeleton->GetJointIDByName( horizontalAimJointName );
...
void CProceduralContextTurretAimPose::SetWeaponJointName( const char* weaponJointName )
{
	...
	const int16 weaponJointId = m_pICharacterModelSkeleton->GetJointIDByName( weaponJointName );
...
void CProceduralContextTurretAimPose::SetAimPosesOriginJointName( const char* aimPosesOriginJointName )
{
	...
	const int16 aimPosesOriginJointId = m_pICharacterModelSkeleton->GetJointIDByName( aimPosesOriginJointName );
