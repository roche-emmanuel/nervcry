	...
	Vec3* playerLeftHandPos, Vec3* playerRightHandPos) const
{
	...
	ICharacterModelSkeleton* pICharacterModelSkeleton = clientCharacter->GetICharacterModel()->GetICharacterModelSkeleton();
	...
	const int16 leftHandJointID = pICharacterModelSkeleton->GetJointIDByName(s_PlayerLeftHandJointName);
	...
	const int16 rightHandJointID = pICharacterModelSkeleton->GetJointIDByName(s_PlayerRightHandJointName);
